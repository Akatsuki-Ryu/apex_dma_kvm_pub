...
void Colors() {
	...
	style.Colors[ImGuiCol_TitleBgActive] = ImColor(34, 34, 34);
}
...
void Overlay::RenderMenu()
{
	...
	const float clear_color_with_alpha[4] = { clear_color.x * clear_color.w, clear_color.y * clear_color.w, clear_color.z * clear_color.w, clear_color.w };
	{
		...
		ImGui::SetNextWindowSize(ImVec2(610, 350), ImGuiCond_Once);
		ImGui::Begin(" Apex Legends - Rebirth", 0, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
		...
		{
			if (ImGui::Button(XorStr("Main"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 0;
			}

			if (ImGui::Button(XorStr("Config"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 1;
			}
			if (ImGui::Button(XorStr("Visuals"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 2;
			}
			if (ImGui::Button(XorStr("Radar"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 3;
			}
			if (ImGui::Button(XorStr("Items"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 4;
			}
			if (ImGui::Button(XorStr("Weapons"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 5;
			}
			if (ImGui::Button(XorStr("Misc"), ImVec2(ImGui::GetContentRegionAvail().x, 35)))
			{
				tabb = 6;
			}
		}
		...
		ImGui::BeginChild("##RightSide", ImVec2(ImGui::GetContentRegionAvail().x, ImGui::GetContentRegionAvail().y), true);
		{
			...
			if (tabb == 0)
			{
				ImGui::Text(XorStr("Main Toggles"));
...
{
	ImGui::SetNextWindowPos(ImVec2(0, 0));
	ImGui::SetNextWindowSize(ImVec2(190, 25), ImGuiCond_Once);
